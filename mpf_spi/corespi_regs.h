 ...
 *
 * SVN $Revision: 7993 $
 * SVN $Date: 2015-10-12 13:21:38 +0530 (Mon, 12 Oct 2015) $
 */
...
/*
 * The clock rate of the generated SPI master clock is determined by the
 * formula: SPICLK = PCLK / (2 * (CLK_DIV + 1))
 * The register value overrides the parameter value (CFG_CLK) set in the core
